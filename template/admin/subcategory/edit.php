   ...
   <form name="site-form" action="{% if form=='edit' %}/admin/catalog/producer/edit/{{category.cat_id}} {% else %} /admin/catalog/producer/add {% endif %}" method="post" enctype="multipart/form-data">        
        ...
        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                <tr>
                    ...
                    <td><input type="text" name="nazwa" class="inp-form" value="{{producer.name}}"/></td>
                    <td></td>
                </tr>
                <tr>
                    <th valign="top">Pozycja:</th>
                    <td><input type="text" name="pozycja" class="inp-form" value="{{producer.pos}}"/></td>
                    <td></td>
                </tr>
                 <tr>
                    <th valign="top">Obrazek:</th>
                    <td><input type="text" name="obrazek" class="inp-form" value="{{producer.img}}"/></td>
